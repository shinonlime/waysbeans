...
export default function NaviBar() {
    ...
    const handleLogout = () => {
        ...
        window.removeEventListener("badge");
    ...
    useEffect(() => {
        ...
        window.addEventListener("badge", updateCartLength);
    }, [userEmail]);
            ...
            return (
                <>
                    <div className="d-flex gap-4 align-items-center">
                        {cartButton()}
                        <NavDropdown title={<img src={profile?.image} alt="" width="50px" height="50px" style={{objectFit: "cover"}} className="rounded-circle dropdown-center" />}>
