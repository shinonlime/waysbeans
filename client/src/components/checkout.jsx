    ...
    const handleSubmit = useMutation(async (e) => {
        try {
            ...
            cartItems.forEach((item) => {
                ...
                formCart.set("product_name", item.name);
                formCart.set("product_price", item.price);
                formCart.set("quantity", item.quantity);
                formCart.set("product_image", item.image);

                API.post("/product-transaction", formCart, config);
            });
