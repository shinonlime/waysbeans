                                                        ...
                                                        <div className="d-flex align-items-center justify-content-between gap-5">
                                                            <div className="d-flex me-5">
                                                                ...
                                                                <div className="d-flex justify-content-between gap-5">
                                                                    <div className="ms-3">
                                                                        <div className="mb-3">
                                                                            <h5 className="text-primary fw-bold mb-1">{item.product_name}</h5>
                                                                            <p className="m-0 text-secondary fw-semibold">{createdAt}</p>
                                                                        </div>
                                                                        <div className="">
                                                                            <p className="m-0 text-secondary">Price: {rupiah(item.product_price)}</p>
                                                                            <p className="m-0 text-secondary">Qty: {item.quantity}</p>
                                                                            <p className="text-secondary fw-bold m-0">Sub Total: {rupiah(item.product_price * item.quantity)}</p>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
